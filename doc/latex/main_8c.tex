...
\item 
\hypertarget{main_8c_a83bf17fca7535cabf55e8fcffbf80c7c}{\-A\-L\-L\-E\-G\-R\-O\-\_\-\-B\-I\-T\-M\-A\-P $\ast$ {\bfseries \-Load\-Scaled\-Bitmap} (char $\ast$filename, int width, int height)}\label{main_8c_a83bf17fca7535cabf55e8fcffbf80c7c}
...
\item 
\hypertarget{main_8c_ab0af27461c4e23c088670da5e6a971ef}{int {\bfseries \-Shared\-\_\-\-Load} (struct \hyperlink{structGame}{\-Game} $\ast$game)}\label{main_8c_ab0af27461c4e23c088670da5e6a971ef}

\item 
\hypertarget{main_8c_af9010ebe7fc75fbd882a9a8bf7b32d0c}{void {\bfseries \-Shared\-\_\-\-Unload} (struct \hyperlink{structGame}{\-Game} $\ast$game)}\label{main_8c_af9010ebe7fc75fbd882a9a8bf7b32d0c}
...
\-Main file of \-Super\-Derpy engine. $\ast$ \-Contains basic functions shared by all views. 
...
case state:\
      ...
      al_flip_display(); name ## _Preload(game, progress); break;
\end{DoxyCode}
